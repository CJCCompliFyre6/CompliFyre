...
document.getElementById("guidelineForm").addEventListener("submit", function(event) {
    ...
    let applicableGeography = document.getElementById("applicableGeography").value;
    let applicableIndustry = document.getElementById("applicableIndustry").value;
    let applicableCategory = document.getElementById("applicableCategory").value;
    let dateOfIssue = document.getElementById("dateOfIssue").value;
    let complianceDate = document.getElementById("complianceDate").value;
    let mandatory = document.querySelector('input[name="mandatory"]:checked')?.value;
    let certification = document.querySelector('input[name="certification"]:checked')?.value;

    if (!guidelineName || !gid || !issuingAuthority || !applicableGeography || !dateOfIssue || !complianceDate || !mandatory || !certification) {
