...
function toggleSubmenu(event) {
  ...
  document.getElementById('iracTab').addEventListener('click', function () {
        document.getElementById('iracContent').style.display = 'block';
        document.getElementById('cyberContent').style.display = 'none';
        this.classList.add('active-tab');
        document.getElementById('cyberTab').classList.remove('active-tab');
    });

    document.getElementById('cyberTab').addEventListener('click', function () {
        document.getElementById('iracContent').style.display = 'none';
        document.getElementById('cyberContent').style.display = 'block';
        this.classList.add('active-tab');
        document.getElementById('iracTab').classList.remove('active-tab');
    });