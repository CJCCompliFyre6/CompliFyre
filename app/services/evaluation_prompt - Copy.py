...
def generate_compliance_prompt(project_control_activity, user_prompt=None) -> str:
    """
    ...
    prompt_parts = [
        ...
        "",
        "## 2. SYSTEM CONTEXT (AUTHORITATIVE – DO NOT OVERRIDE)",
        "",
        ...
        "",
        "## 3. INPUTS YOU WILL RECEIVE (EVIDENCE UNIVERSE)",
        "",
    ...
    # Add evidence requirements from project-specific artifacts
    prompt_parts.extend(
        [
            "### Evidence Artifacts Submitted for Review:",
            "",
        ]
    )
